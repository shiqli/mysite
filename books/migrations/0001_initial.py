...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'books_article', (
            ...
            ('journal', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['books.Journal'])),
        ...
        m2m_table_name = db.shorten_name(u'books_article_authors')
        db.create_table(m2m_table_name, (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('article', models.ForeignKey(orm[u'books.article'], null=False)),
            ('author', models.ForeignKey(orm[u'books.author'], null=False))
    ...
    def backwards(self, orm):
        ...
        db.delete_table(db.shorten_name(u'books_article_authors'))


    models = {
        u'books.article': {
            'Meta': {'ordering': "('year',)", 'object_name': 'Article'},
            ...
            'journal': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['books.Journal']"}),
